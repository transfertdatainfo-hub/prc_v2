    ...
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Accédez à votre espace PRIVATIS CAPITAL
        </p>
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full py-2.5 border border-gray-300 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
        >
